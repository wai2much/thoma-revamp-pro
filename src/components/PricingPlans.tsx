...
const plans = [
  ...
  },
  {
    ...
    savings: 4950,
    features: [
      "3x Logbook Services per ticket",
      "3x Rotate & Balance per ticket",
      "3x Wheel Alignment per ticket",
      "3x Engine Diagnostics per ticket",
      "3x Fault Full System Scans per ticket",
      "3x Coolant Flush per ticket",
      "3x Power Steering Flush per ticket",
      "3x Brake Fluid Flush per ticket",
      "Unlimited Puncture Repairs",
      ...
      <div className="container max-w-7xl mx-auto relative z-10">
        ...
        <div className="flex flex-wrap items-center justify-center gap-8 mt-16 text-sm text-muted-foreground font-mono uppercase tracking-wider">
          <div className="flex items-center gap-2">
            ...
            <span>Annual = No lock-up</span>
          </div>
          <div className="flex items-center gap-2">
            <Check className="h-4 w-4 text-accent" />
            <span>Monthly = 2-month lock-up</span>
          </div>
          <div className="flex items-center gap-2">
            <Check className="h-4 w-4 text-primary" />
