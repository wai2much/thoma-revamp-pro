    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-accent/5 to-background p-4">
      <div className="max-w-md mx-auto pt-8">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold mb-2">TyrePlus Loyalty Program</h1>
        ...
        <Card className="glass-card overflow-hidden">
          ...
          <div className="p-6 space-y-4">
            <div className="text-center">
              <div className="text-4xl font-bold text-primary mb-2">{memberData.credit}</div>
              <div className="text-sm text-muted-foreground">Welcome Credit</div>
            </div>

            <div className="grid grid-cols-2 gap-4 py-4 border-y border-border">
              <div className="text-center">
                <div className="font-semibold">{memberData.memberName}</div>
                <div className="text-xs text-muted-foreground">Member</div>
              </div>
              <div className="text-center">
                <div className="font-semibold">{memberData.memberId}</div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="text-center">
                <div className="font-semibold">{memberData.memberSince}</div>
                <div className="text-xs text-muted-foreground">Since</div>
              </div>
              <div className="text-center">
                <div className="font-semibold text-accent">{memberData.points} pts</div>
        ...
        {/* Wallet Pass Buttons - Primary Action */}
        {(memberData.appleUrl || memberData.googleUrl) && (
          <Card className="glass-card mt-6 p-6 space-y-4">
            <div className="text-center">
              <Smartphone className="h-8 w-8 mx-auto mb-2 text-primary" />
              <h3 className="font-semibold text-lg">Add to Your Wallet</h3>
              <p className="text-sm text-muted-foreground">Get instant access with push notifications</p>
            </div>
          ...
          <Card className="glass-card mt-6 p-6">
            <details className="group">
              <summary className="cursor-pointer text-center text-sm text-muted-foreground hover:text-foreground">
                Show QR Code for in-store scanning
              </summary>
